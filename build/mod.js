...
const importMeta = {
    url: "file:///home/cykrix/deno/git-hooked/mod.ts",
...
INSTALL:
  deno install --allow-write=./.git/ --allow-read=./git-scripts/ -n git-hooked https://raw.githubusercontent.com/amethyst-studio/git-hooked/main/mod.ts
...
OPTIONS:
  ...
  --list-hooks               List all supported git-hooks.
  --list-scripts             List all local scripts that are mapped to a supported git-hook.
  --verbose                  Print additional output of the steps taken by the script.
  --quiet                    Disregard all non-stderr output.
